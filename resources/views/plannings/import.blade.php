...
<div id="importModal" class="fixed inset-0 hidden items-center justify-center z-50 p-4 modal-backdrop">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg transform transition-all max-h-[90vh] overflow-y-auto">
        ...
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 sticky top-0 bg-white">
            <h2 class="text-xl font-bold text-gray-900">Import Data Planning</h2>
        ...
        <form id="importForm" class="p-6 space-y-4" enctype="multipart/form-data">
                ...
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        ...
                        <ul class="mt-2 text-sm text-blue-700 space-y-1">
                            ...
                            <li>• Kolom <strong>ID</strong> atau <strong>PART_NO_FG</strong> minimal salah satu diisi</li>
                            <li>• Header kolom akan dideteksi otomatis</li>
                            <li>• Format datetime: YYYY-MM-DD HH:MM:SS</li>
                        </ul>
                        <a href="{{ route('plannings.template') }}" 
            ...
            <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
                <h4 class="text-sm font-semibold text-gray-800 mb-2">Kolom yang Didukung:</h4>
                <div class="text-xs text-gray-600 space-y-1">
                    <p><strong>Basic:</strong> ID, JUDGEMENT, PRIORITY, PART_NO_FG, PART_NO_PARENT, PART_NO_CHILD</p>
                    <p><strong>Location:</strong> STORE, PROCESS, LINE, RACK_NO</p>
                    <p><strong>Quantity:</strong> QTY_KBN, QTY_CONSUME, QTY_LOT, STOCK_MIN, STOCK_MAX</p>
                    <p><strong>Production:</strong> TOTAL_PROD, STATUS, ACTUAL, LOT_NO, CALC_BY</p>
                    <p><strong>Time:</strong> PULLING_TIME, START_TIME, END_TIME, CALC_TIME</p>
                </div>
            </div>
            ...
            <div id="importErrors" class="hidden bg-red-50 border border-red-200 rounded-lg p-4">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        ...
                        <ul class="mt-2 text-sm text-red-700 space-y-1 list-disc list-inside max-h-32 overflow-y-auto" id="importErrorList">
                        </ul>
                    </div>
                </div>
            </div>
